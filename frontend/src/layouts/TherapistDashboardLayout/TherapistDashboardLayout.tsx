  ...
  return (
    <div className="flex flex-col px-5 md:px-20 py-5 gap-10 text-main-text relative">
      {(authUser as unknown as Therapist).validationStatus === "pending" && (
        <div className="w-full self-center bg-yellow-200 text-yellow-800 border border-yellow-300 rounded-lg p-4 flex items-center justify-center gap-5">
      ...
      {(authUser as unknown as Therapist).validationStatus === "rejected" && (
        <div className="w-full self-center bg-red-200 text-red-800 border border-red-300 rounded-lg p-4 flex items-center justify-center gap-5">
          <IoIosWarning className="size-10" />
          <p className="">
