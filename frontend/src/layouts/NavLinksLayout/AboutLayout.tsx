    ...
    <div className="w-full">
      ...
      <div className="text-lg p-2 sm:p-10 md:p-10 flex flex-col gap-20 justify-center items-center">
        ...
        <div className="flex flex-col gap-20 lg:flex-row">
          {/* About Therafind  */}
          <div className="max-w-200 self-end bg-[var(--cbg-one)] p-10 md:p-15 rounded-4xl flex-3/4">
            <div className="text-5xl font-bold text-[var(--text)] mb-5 w-max flex flex-col items-start">
          ...
          {/* The Vision  */}
          <div className="max-w-200 self-end bg-[var(--cbg-two)] p-10 md:p-20 rounded-4xl flex-2/3">
            <div className="text-5xl font-bold text-[var(--text)] mb-5 flex flex-col items-end">
        ...
        {/* Academic Purpose  */}
        <div className=" xl:w-300 self-center bg-[var(--cbg-three)] p-10 md:p-20 rounded-4xl">
          <div className="text-5xl font-bold text-[var(--text)] mb-5 flex flex-col items-start">
